...
### 🔧 Fixed
- Fix a bug in the "Drop bad epochs" dialog to ensure invalid decimal separators cannot be entered ([531](https://github.com/cbrnr/mnelab/pull/531) by [Fabian Schellander](https://github.com/SchellanderF))
