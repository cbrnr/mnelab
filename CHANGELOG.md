...
- Parameterize imported bad-channel, annotation, and ICA sidecar files in saved pipelines ([#625](https://github.com/cbrnr/mnelab/pull/625) by [Dennis Wambacher](https://github.com/D3njo/))
- Move dataset provenance details into a dedicated dialog, remove visible pipeline numbering, and treat montage changes as shared-data steps ([#625](https://github.com/cbrnr/mnelab/pull/625) by [Dennis Wambacher](https://github.com/D3njo/))
