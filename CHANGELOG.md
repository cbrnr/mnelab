...
- Add support for plotting evoked potentials averaged over channels (Plot -> Evoked (average)...) ([#256](https://github.com/cbrnr/mnelab/pull/256) by [Florian Hofer](https://github.com/hofaflo))
