...
### Fixed 
- Fixed a bug where appending data would not be correctly displayed in the history ([#446]) https://github.com/cbrnr/mnelab/pull/446 by [bkloeckl] (https://github.com/bkloeckl))
