...
- Enable epoching of continuous data ([#45](https://github.com/cbrnr/mnelab/pull/28) by [Tanguy Vivier](https://github.com/TyWR) and [Clemens Brunner](https://github.com/cbrnr))
