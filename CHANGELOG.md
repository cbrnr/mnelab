...
- Add support for plotting topomaps of evoked potentials (Plot -> Topomap evoked...) ([#277](https://github.com/cbrnr/mnelab/pull/277) by [Florian Hofer](https://github.com/hofaflo))
