    ...
    def run_ica(self):
        ...
        if dialog.exec_():
            ...
            if not dialog.extended.isHidden():
                ...
                self.model.history.append('fit_params["extended"] = {}'.format(dialog.extended.isChecked()))

            if not dialog.ortho.isHidden():
                fit_params["ortho"] = dialog.ortho.isChecked()
                self.model.history.append('fit_params["ortho"] = {}'.format(dialog.ortho.isChecked()))
