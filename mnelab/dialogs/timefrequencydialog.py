...
class PlotTFDialog(QDialog):
    def __init__(self, parent, methods, t_range, f_range, modes,
        ...
        grid.addWidget(QLabel("Cycles:"), 3, 0)
        grid.addWidget(QLabel(" Frequency /"), 3, 2)

        self._n_cycles = QDoubleSpinBox()
        self._n_cycles.setRange(1., 8.)
        self._n_cycles.setValue(1.)
        self._n_cycles.setDecimals(1)
        grid.addWidget(self._n_cycles, 3, 3)

        # Baseline
        grid.addWidget(QLabel("Baseline correction:"), 4, 0)
        ...
        grid.addWidget(self.baseline_checkbox, 4, 1)
        ...
        grid.addWidget(self._start_baseline, 4, 2, 1, 2)
