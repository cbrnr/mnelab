...
class PSDDialog(QDialog):
    def __init__(self, parent, fmin, fmax, montage):
        ...
        fmin_tooltip = "Set the lowest frequency included in the PSD plot"
        fmin_label.setToolTip(fmin_tooltip)
        self.fmin_input.setToolTip(fmin_tooltip)
        ...
        fmax_tooltip = "Set the highest frequency included in the PSD plot"
        fmax_label.setToolTip(fmax_tooltip)
        self.fmax_input.setToolTip(fmax_tooltip)
        ...
        bad_tooltip = "Include channels marked as bad in the PSD plot"
        bad_label.setToolTip(bad_tooltip)
        self.bad_checkbox.setToolTip(bad_tooltip)
        ...
        color_tooltip = "Color traces by channel position (requires a montage)"
        color_label.setToolTip(color_tooltip)
        self.color_checkbox.setToolTip(color_tooltip)
